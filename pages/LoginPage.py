...
class Login:
    ...
    def enter_username(self):
        locator_type_value = (By.CSS_SELECTOR, self.email_field_locator_value)
        ...
        # self.element.get_element(locator_type_value, True, 5) Here the element is explicitly waitied and 5 second wait time is applied

        email_field = self.element.get_element(locator_type_value)
        email_field.send_keys("student")


    def enter_password(self, password: str):
        locator_type_value = (By.CSS_SELECTOR, self.password_field_locator_value)

        password_field = self.element.get_element(locator_type_value)
        password_field.send_keys(password)


    def click_submit(self):
        locator_type_value = (By.XPATH, self.button_locator_value)

        # Using explicit wait
        button = self.element.get_element(locator_type_value, use_wait=True, wait_time=5)
        button.click()

    
    def checkLoggedInMessage(self):
        locator_type_value = (By.CSS_SELECTOR, self.logged_in_msg_locator_value)

        heading_element = self.element.get_element(locator_type_value, wait_time=True)
    ...
    def enter_username_2(self):
        ...
        email_field = self.element.get_element(locator_type_value, use_wait=True)
    ...
    def click_submit_2(self):
        locator_type_value = (By.CSS_SELECTOR, self.button_locator_value_2)

        button = self.element.get_element(locator_type_value)
        button.click()
